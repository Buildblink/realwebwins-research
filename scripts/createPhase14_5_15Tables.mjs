...
async function runMigration() {
  console.log("🚀 Running Phase 14.5 → 15 migration...\n");

  try {
    // Read the SQL migration file
    const sqlPath = join(__dirname, "migrations", "create_phase14_5_15_tables.sql");
    ...
    console.log("✅ Phase 14.5 → 15 tables created successfully!\n");
    console.log("Created/Updated tables:");
    console.log("  - workspace_remixes (updated structure)");
    console.log("  - referral_clicks (referral link tracking)");
    console.log("  - affiliate_clicks (affiliate link tracking)");
    console.log("  - user_credits (simple credit balance)");
    console.log("\n✅ Migration complete!");
    ...
    console.error("   2. Run the SQL from scripts/migrations/create_phase14_5_15_tables.sql");
    process.exit(1);
  }
}
