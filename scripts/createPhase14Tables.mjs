...
async function runMigration() {
  console.log("🚀 Running Phase 14 migration...\n");

  try {
    // Read the SQL migration file
    const sqlPath = join(__dirname, "migrations", "create_phase14_tables.sql");
    ...
    console.log("✅ Phase 14 tables created successfully!\n");
    console.log("Created tables:");
    console.log("  - profiles (user public profiles)");
    console.log("  - public_workspaces (published workspace listings)");
    console.log("  - referrals (referral tracking)");
    console.log("  - workspace_remixes (remix tracking)");
    console.log("\nUpdated tables:");
    console.log("  - workspaces (added published_workspace_id column)");
    console.log("\n✅ Migration complete!");
    ...
    console.error("   2. Run the SQL from scripts/migrations/create_phase14_tables.sql");
    process.exit(1);
  }
}
